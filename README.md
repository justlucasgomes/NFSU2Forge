...
- **26 confirmed physics fields** per car, all editable via sliders and spinboxes
- **Chassis** — mass, brake force, center of gravity height
- **Engine** — turbo boost, peak RPM, redline, full 9-point torque curve
- **Gearbox** — gear ratios 1–4
...
- **28 playable cars** supported, including Peugeot 106 & 206
...
| Class | Cars |
|-------|------|
| Tuner | 240SX · Civic · Eclipse · RSX · Sentra · Lancer · Neon · Tiburon · Audi TT · Audi A3 · Golf GTI · Celica · Focus · Corolla · Peugeot 206 · Peugeot 106 · Corsa |
| Sport | 350Z · 3000GT · G35 · IS300 · RX-8 · Miata · S2000 · RX-7 · Skyline · Supra |
| Muscle | Mustang GT · GTO |
| Exotic | Impreza WRX · Lancer Evo 8 · Impreza |
...
Click any car in the left sidebar to load its physics data.
...
| **Engine** | Turbo Boost, Peak RPM, Redline, Torque curve (9 points) |
| **Gearbox** | Gear ratios 1–4 (higher = more torque, lower = higher top speed) |
...
```bash
git clone https://github.com/YOUR_USERNAME/NFS2Forge.git
cd NFS2Forge
